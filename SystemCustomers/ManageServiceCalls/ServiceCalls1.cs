...
namespace SystemCustomers.ManageServiceCalls
{
    public partial class ServiceCalls1 : Form
    {
        ...
        public ServiceCalls1(string idCallsServices, string idCustomers, string customerName,
          string discriptions, string priority, string idPriority, string status)
        {
            InitializeComponent();
            ...
            this._companyName = customerName;
        ...
        {
            get { return textbStatus.Text; }
            set { textbStatus.Text = value; }
        }
