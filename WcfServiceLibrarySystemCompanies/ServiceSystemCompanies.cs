...
namespace WcfServiceLibrarySystemCompanies
{
    ...
    public class ServiceSystemCompanies : IServiceSystemCompanies
    {
        ...
        public Product MangeProducts(Product product)
        {
            var objProduct = new ProductService();
            switch (product.Method)
            {
                ...
                case "Update":
                    ...
                    break;
                case "Delete":
                    objProduct.DeleteService(product);
                    break;
                case "GetAllProduct":
                    product.ProductData = objProduct.GetAllProduct();
                    break;
                case "GetAllProductDataSet":
                    product.ProductDataSet = objProduct.GetAllProductsDataSet();
                    break;
                case "GetAllProductToDropDown":
                    product.list = objProduct.GetAllProductsToDropDown();
                    break;
                case "CheckProductId":
                    product.isBool = objProduct.CheckProductId(product);
                    break;
            }
            return product;
        }
