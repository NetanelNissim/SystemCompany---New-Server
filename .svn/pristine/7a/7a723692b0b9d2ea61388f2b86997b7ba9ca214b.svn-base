...
{
    partial class AboutBoxServiceCustomers : Form
    {
        public AboutBoxServiceCustomers()
        {
            InitializeComponent();
        ...
        private void AboutBoxServiceCustomers_MouseClick(object sender, MouseEventArgs e)
        {
            this.Close();
            GC.Collect();
        }
        ...
        private void labelCompanyName_MouseClick(object sender, MouseEventArgs e)
        {
            this.Close();
            GC.Collect();
        }
